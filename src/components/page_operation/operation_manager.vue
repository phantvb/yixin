                    ...
                    <el-form :model="Form" :rules="rules" ref="Form" label-width="120px" class="demo-ruleForm" size="mini">
                        ...
                        <ul  v-show="detail_type==0">
                            ...
                            <li>
                              ...
                              <div class="grey">{{Form.token}}</div>
                            </li>
                            <li>
                                <p class="black">手机：</p>
                                <div class="grey">{{Form.phone}} </div>
                            </li>
                        </ul>
                    </el-form>
                </div>
...
export default {
    ...
    methods:{
        ...
        findSeat:function(){
            var data={
                'type':this.type,'state':this.worker_state,'startTime':this.search_date!=null?this.search_date[0]+' 23:59:59':"",'endTime':this.search_date!=null?this.search_date[1]+' 23:59:59':"",'requireTotalCount':true,'fullNameOrEmail':this.search
            };
            for (let key in data){
                if(data[key]==''){
                    delete data[key];
        ...
        sort_change({column, prop, order} ){
            ...
            var data={'state':this.worker_state,'startTime':this.search_date!=null?this.search_date[0]+' 23:59:59':"",'endTime':this.search_date!=null?this.search_date[1]+' 23:59:59':"",'requireTotalCount':true,'fullNameOrEmail':this.search,'pageNum':this.pageNum,"orderWay":this.orderWay,'orderField':this.orderField};
            for (let key in data){
                if(data[key]==''){
                    delete data[key];
                }
