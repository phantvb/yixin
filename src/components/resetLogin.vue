            ...
            <div class="loginBox">
                <div v-if="resetPass" class="resetPassword">
                    ...
                    <form @submit.prevent="resetPassWord">
                        ...
                        <!-- 新密码 -->
                        <div class="loginForm">
                           <el-input placeholder="请输入新密码" type="password" suffix-icon="el-icon-view" v-model="formPass.newPassWord"></el-input>
                        </div>
                        <!-- 二次确认密码 -->
                        <div class="loginForm">
                           <el-input placeholder="请再次输入新密码" type="password" suffix-icon="el-icon-view" v-model="formPass.PassWord"></el-input>
                        </div>
                        <div class="loginForm">
                            <!-- 验证码输入框 -->
                            <div class="verify">
...
export default {
    ...
    created(){
        ...
        this.tokens = this.$route.query.token;
        //  回填在重置密码上方
        let parameter = {
          "token":this.tokens
        }
